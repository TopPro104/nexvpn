...
- **Темы** — 8 цветовых тем (dark, light, nord, dracula, monokai, solarized, gruvbox, catppuccin)
...
- **Лёгкий** — один бинарник, без Electron, ~5 МБ

## Скачать

Готовые установщики для Windows (x64) доступны на странице [Releases](../../releases).
