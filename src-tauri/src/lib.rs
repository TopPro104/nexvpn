...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_routing_profiles,
            commands::import_routing_profile,
            commands::set_active_routing_profile,
            commands::delete_routing_profile,
            commands::update_routing_geo,
            commands::save_routing_profile,
            commands::reset_routing_profile,
            commands::create_routing_profile,
            commands::export_routing_profile,
            commands::get_geo_codes,
            commands::get_geo_category,
