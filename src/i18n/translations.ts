...
const translations = {
  ...
  "routing.domainPlaceholder": { en: "e.g. example.com, geosite:category-ru, geoip:ru, 10.0.0.0/8", ru: "напр. example.com, geosite:category-ru, geoip:ru, 10.0.0.0/8" },
  ...
  "routing.customRules": { en: "Custom Rules", ru: "Свои правила" },
  "routing.customOverride": { en: "Custom rules always take priority over the routing profile.", ru: "Свои правила всегда приоритетнее профиля маршрутизации." },
  "routing.syntaxHint": {
    en: "Supported: domain (with subdomains), full:host, keyword:text, regexp:re, geosite:category, geoip:cc, IP or CIDR",
    ru: "Поддерживается: домен (с поддоменами), full:хост, keyword:текст, regexp:выражение, geosite:категория, geoip:код страны, IP или CIDR",
  },

  // Routing profiles (Happ format)
  "routing.profile": { en: "Routing Profile", ru: "Профиль маршрутизации" },
  "routing.profileDesc": {
    en: "A ready-made rule set (Happ format): which sites and IPs go direct, via proxy or get blocked, plus DNS settings. Your provider can deliver one with a subscription.",
    ru: "Готовый набор правил (формат Happ): какие сайты и IP идут напрямую, через прокси или блокируются, плюс настройки DNS. Провайдер может прислать его вместе с подпиской.",
  },
  "routing.profileOff": { en: "Off", ru: "Выключен" },
  "routing.profileOffDesc": { en: "No profile: only your custom rules and the default route apply.", ru: "Без профиля: действуют только ваши правила и маршрут по умолчанию." },
  "routing.profileFromSub": { en: "Subscription", ru: "Подписка" },
  "routing.profileFromSubTitle": { en: "Delivered by subscription", ru: "Получен из подписки" },
  "routing.catDirect": { en: "Direct", ru: "Напрямую" },
  "routing.catProxy": { en: "Proxy", ru: "Прокси" },
  "routing.catBlock": { en: "Block", ru: "Блок" },
  "routing.otherTraffic": { en: "Other traffic", ru: "Остальной трафик" },
  "routing.otherGoes": { en: "other traffic goes", ru: "остальной трафик идёт" },
  "routing.viaProxy": { en: "via proxy", ru: "через прокси" },
  "routing.viaDirect": { en: "direct", ru: "напрямую" },
  "routing.setByProfile": { en: "Set by the active profile", ru: "Задаётся активным профилем" },
  "routing.geoUpdatedAt": { en: "Geo files updated", ru: "Geo-файлы обновлены" },
  "routing.geoNever": { en: "Geo files not downloaded yet", ru: "Geo-файлы ещё не загружены" },
  "routing.geoError": { en: "Geo files error", ru: "Ошибка geo-файлов" },
  "routing.geoRefresh": { en: "Update geo files", ru: "Обновить geo-файлы" },
  "routing.showDetails": { en: "Show details", ru: "Подробнее" },
  "routing.hideDetails": { en: "Hide details", ru: "Скрыть подробности" },
  "routing.deleteProfile": { en: "Delete profile", ru: "Удалить профиль" },
  "routing.profileDeleteConfirm": { en: "Delete routing profile", ru: "Удалить профиль маршрутизации" },
  "routing.profileDeleteSubNote": {
    en: "It was delivered by a subscription and will come back on the next subscription update.",
    ru: "Он получен из подписки и вернётся при следующем обновлении подписки.",
  },
  "routing.profileDeleted": { en: "Routing profile deleted", ru: "Профиль маршрутизации удалён" },
  "routing.profileActivated": { en: "Routing profile enabled", ru: "Профиль маршрутизации включён" },
  "routing.profileTurnedOff": { en: "Profile routing turned off", ru: "Маршрутизация по профилю выключена" },
  "routing.profileImported": { en: "Routing profile added", ru: "Профиль маршрутизации добавлен" },
  "routing.profileImportedActive": { en: "Routing profile added and enabled", ru: "Профиль маршрутизации добавлен и включён" },
  "routing.profilesLoadError": { en: "Could not load routing profiles", ru: "Не удалось загрузить профили маршрутизации" },
  "routing.addProfile": { en: "Add Profile", ru: "Добавить профиль" },
  "routing.importPlaceholder": { en: "happ://routing/… or JSON", ru: "happ://routing/… или JSON" },
  "routing.importing": { en: "Importing routing profile…", ru: "Импорт профиля маршрутизации…" },
  "routing.importBusy": { en: "Downloading geo files, this can take a minute…", ru: "Загружаются geo-файлы, это может занять минуту…" },
  "routing.builtinRu": { en: "Built-in: Russian sites direct", ru: "Встроенный: российские сайты напрямую" },
  "routing.builtinRuDesc": { en: "Russian sites and IPs go direct, everything else via proxy.", ru: "Российские сайты и IP — напрямую, всё остальное — через прокси." },
  "routing.builtinAdded": { en: "Already added", ru: "Уже добавлен" },
  "routing.routeOrder": { en: "Rule order", ru: "Порядок правил" },
  "routing.domainStrategy": { en: "Domain strategy", ru: "Стратегия доменов" },
  "routing.remoteDns": { en: "Remote DNS (via proxy)", ru: "Удалённый DNS (через прокси)" },
  "routing.domesticDns": { en: "Domestic DNS (direct)", ru: "Локальный DNS (напрямую)" },
  "routing.dnsHosts": { en: "DNS hosts", ru: "DNS-хосты" },
  "routing.directSites": { en: "Direct sites", ru: "Сайты напрямую" },
  "routing.directIp": { en: "Direct IPs", ru: "IP напрямую" },
  "routing.proxySites": { en: "Proxy sites", ru: "Сайты через прокси" },
  "routing.proxyIp": { en: "Proxy IPs", ru: "IP через прокси" },
  "routing.blockSites": { en: "Blocked sites", ru: "Блокируемые сайты" },
  "routing.blockIp": { en: "Blocked IPs", ru: "Блокируемые IP" },
  "routing.noEntries": { en: "No list entries", ru: "Списки пусты" },
  "routing.showMore": { en: "+{n} more", ru: "ещё {n}" },
  "routing.showLess": { en: "Show less", ru: "Свернуть" },

  // Routing profile editor
  "routing.editProfile": { en: "Edit profile", ru: "Редактировать профиль" },
  "routing.copyLink": { en: "Copy link", ru: "Скопировать ссылку" },
  "routing.linkCopied": { en: "Profile link copied", ru: "Ссылка на профиль скопирована" },
  "routing.linkTitle": { en: "Profile link", ru: "Ссылка на профиль" },
  "routing.edited": { en: "Edited", ru: "Изменён" },
  "routing.editedTitle": { en: "Changed from the original version", ru: "Изменён относительно исходной версии" },
  "routing.createProfile": { en: "Create profile", ru: "Создать профиль" },
  "routing.createProfileDesc": { en: "Start from default values and edit.", ru: "Начать с настроек по умолчанию и отредактировать." },
  "routing.newProfileName": { en: "My profile", ru: "Мой профиль" },
  "routing.secGeneral": { en: "General", ru: "Основное" },
  "routing.secRules": { en: "Rules", ru: "Правила" },
  "routing.secDns": { en: "DNS", ru: "DNS" },
  "routing.secGeo": { en: "Geo files", ru: "Geo-файлы" },
  "routing.name": { en: "Name", ru: "Название" },
  "routing.strategyAsIs": { en: "Only domain rules; IP rules match only connections made by IP.", ru: "Только правила по доменам; правила по IP срабатывают только для соединений по IP." },
  "routing.strategyIPIfNonMatch": { en: "Recommended. If no domain rule matched, the domain is resolved and checked against IP rules.", ru: "Рекомендуется. Если ни одно доменное правило не подошло, домен резолвится и проверяется по IP-правилам." },
  "routing.strategyIPOnDemand": { en: "Resolve domains for IP rules as well (works like IPIfNonMatch in NexVPN).", ru: "Резолвить домены и для IP-правил (в NexVPN работает как IPIfNonMatch)." },
  "routing.sites": { en: "Sites", ru: "Сайты" },
  "routing.ips": { en: "IP addresses", ru: "IP-адреса" },
  "routing.entryPlaceholderSite": { en: "geosite:…, domain:…, keyword…", ru: "geosite:…, domain:…, слово…" },
  "routing.entryPlaceholderIp": { en: "geoip:…, 1.2.3.0/24…", ru: "geoip:…, 1.2.3.0/24…" },
  "routing.profileSyntaxHint": {
    en: "In profiles a plain word is a keyword (substring) match, like in Happ/Xray. Use domain:example.com for a domain with subdomains, full: for an exact host, regexp: for a regex, geosite:/geoip: for categories. Paste several entries at once separated by commas or new lines. Click a geosite/geoip chip to see what's inside.",
    ru: "В профилях просто слово — это поиск по вхождению (keyword), как в Happ/Xray. Для домена с поддоменами пишите domain:example.com, для точного хоста full:, для регулярки regexp:, для категорий geosite:/geoip:. Можно вставить сразу несколько записей через запятую или с новой строки. Нажмите на geosite/geoip, чтобы посмотреть содержимое.",
  },
  "routing.dnsRemoteTitle": { en: "Remote (through VPN)", ru: "Удалённый (через VPN)" },
  "routing.dnsDomesticTitle": { en: "Domestic (direct)", ru: "Локальный (напрямую)" },
  "routing.dnsRemoteDesc": { en: "Resolves proxied domains; queries go through the VPN.", ru: "Резолвит домены, идущие через прокси; запросы идут через VPN." },
  "routing.dnsDomesticDesc": { en: "Resolves domains from the direct lists; queries go directly.", ru: "Резолвит домены из списков «напрямую»; запросы идут напрямую." },
  "routing.dnsType": { en: "Type", ru: "Тип" },
  "routing.dnsUrl": { en: "DoH URL", ru: "DoH URL" },
  "routing.dnsIp": { en: "Server IP", ru: "IP сервера" },
  "routing.hostName": { en: "Host", ru: "Хост" },
  "routing.addHost": { en: "Add host", ru: "Добавить хост" },
  "routing.noHosts": { en: "No static hosts", ru: "Статических хостов нет" },
  "routing.geositeUrl": { en: "Geosite URL", ru: "Ссылка на geosite" },
  "routing.geoipUrl": { en: "GeoIP URL", ru: "Ссылка на geoip" },
  "routing.geoUrlNote": { en: "Changing a URL re-downloads the files on save.", ru: "При изменении ссылки файлы скачаются заново при сохранении." },
  "routing.geoCodesHint": { en: "{n} geosite and {m} geoip categories available for autocomplete.", ru: "Для подсказок доступно категорий: geosite — {n}, geoip — {m}." },
  "routing.geoCodesMissing": { en: "Geo files aren't downloaded yet, so there are no category suggestions.", ru: "Geo-файлы ещё не загружены, поэтому подсказок категорий нет." },
  "routing.subEditNote": {
    en: "Your changes are kept until the provider sends a new version of this profile, which replaces them.",
    ru: "Ваши изменения сохраняются, пока провайдер не пришлёт новую версию профиля — тогда она их заменит.",
  },
  "routing.save": { en: "Save", ru: "Сохранить" },
  "routing.saving": { en: "Saving… geo files may be downloading", ru: "Сохранение… могут загружаться geo-файлы" },
  "routing.profileSaved": { en: "Routing profile saved", ru: "Профиль маршрутизации сохранён" },
  "routing.discardChanges": { en: "Discard unsaved changes?", ru: "Отменить несохранённые изменения?" },
  "routing.resetToOriginal": { en: "Reset to original", ru: "Сбросить к исходному" },
  "routing.resetConfirm": { en: "Reset the profile to its original version? Your changes will be lost.", ru: "Сбросить профиль к исходной версии? Ваши изменения будут потеряны." },
  "routing.profileReset": { en: "Profile reset to the original version", ru: "Профиль сброшен к исходной версии" },
  "routing.geoPreviewTotal": { en: "{n} entries", ru: "Записей: {n}" },
  "routing.geoPreviewFirst": { en: "Showing the first {n}", ru: "Показаны первые {n}" },
  "routing.geoPreviewNotFound": { en: "This category isn't in the downloaded geo files — the entry will be skipped.", ru: "Этой категории нет в загруженных geo-файлах — запись будет пропущена." },
  "routing.geoPreviewHint": { en: "Click to see what's inside", ru: "Нажмите, чтобы посмотреть содержимое" },
